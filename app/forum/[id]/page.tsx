...
export default async function ForumDetayPage(props: Props) {
  ...
  // 2. TEK BİR Konuyu Çekiyoruz (Listeyi değil!)
  ...
  if (error || !konu) {
      return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            ...
            <Link href="/forum" className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-bold">Geri Dön</Link>
        </div>
      );
  }

  // 3. O konuya ait Yorumları Çekiyoruz
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32">
        ...
        <div className="bg-white p-4 sticky top-0 z-10 border-b border-gray-100 flex items-center gap-3 shadow-sm">
            ...
            <h1 className="font-bold text-gray-800 text-lg truncate">Konu Detayı</h1>
        </div>
        ...
        <div className="fixed bottom-0 left-0 w-full bg-white p-4 border-t border-gray-100 z-50 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
