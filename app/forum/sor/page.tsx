            ...
            <form onSubmit={gonder} className="space-y-5">
                <div>
                    ...
                    <input 
                        ...
                        placeholder="Örn: Diş çıkarma dönemi..." 
                        className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all font-medium"
                        required
                    />
                </div>
                ...
                <div>
                    ...
                    <div className="relative">
                        <select 
                            ...
                            className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 appearance-none transition-all text-gray-700"
                        >
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        className="w-full p-3.5 bg-gray-50 border border-gray-200 rounded-xl h-40 outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 resize-none transition-all"
                        required
                    />
                </div>
