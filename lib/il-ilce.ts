// Türkiye İl-İlçe Listesi (Genişletilmiş Versiyon)
export const TURKIYE_VERISI: Record<string, string[]> = {
...
// Tüm il isimlerini dizi olarak al
export const TUM_ILLER = Object.keys(TURKIYE_VERISI).sort();